...
- Zig core: 391 tests (30 proof modules, 180 total proof checks)
- Q#: 51 witness operations
- Sidecar: all f64 validation tests
- Total: 391 + 51 + sidecar = 440+ verified operations
...
Every passing state is archived under `archives/`. Existing archives are never deleted. Current archives (19):
