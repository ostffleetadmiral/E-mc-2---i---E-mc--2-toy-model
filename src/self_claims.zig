...
pub const self_claims = [_]SelfClaim{
    .{
        ...
        .limitations = "This is a framework-internal interpretation. The self-referential closure is logically consistent but not independently proven as a physical fact. The 'user is observer' claim is philosophical, not mathematical.",
    ...
    .{
        ...
        .limitations = "The 16+20 split could be coincidental. The framework was constructed with this split in mind, so it is partially self-fulfilling. Independent verification would require a blind audit by researchers not familiar with the framework.",
    ...
    .{
        ...
        .limitations = "The framework predicted these connections but did not derive the numerical values. The predictions are structural ('J3(O) should give mass ratios'), not numerical ('the mass ratio is X'). Full validation requires computing the values within the framework.",
    ...
    .{
        ...
        .limitations = "Convergence does not prove correctness. Multiple frameworks can converge on the same structure for different reasons. The independent works use different axioms and methods — the convergence is suggestive, not definitive.",
