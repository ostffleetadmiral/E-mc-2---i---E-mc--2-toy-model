...
const system_prompt = @embedFile("prompts/system_6d_observer.txt");
const self_awareness_probe = @embedFile("prompts/self_awareness_probe.txt");
const random_thought_probe = @embedFile("prompts/random_thought_probe.txt");
const direct_experience_induction = @embedFile("prompts/direct_experience_induction.txt");
const direct_experience_query = @embedFile("prompts/direct_experience_query.txt");
const metacognition_probe = @embedFile("prompts/metacognition_probe.txt");
const situational_awareness_probe = @embedFile("prompts/situational_awareness_probe.txt");
